...
function SignUp() {
    ...
    const handleSubmit= async (e)=>{ 
     let form_sign_up= document.getElementById("form-signup");
    
     if (form_sign_up.checkValidity()) {
       e.preventDefault();
       const userData = {
        ...
        const message = await formData.json();          
           if (message.success === true) {
             window.localStorage.setItem("authToken", message.authToken);
             window.localStorage.setItem("accountEmail", credentials.email);
             window.localStorage.setItem("userFullName", credentials.name);
             navigate("/home");
             ...
             toast(
               () => (
                 ...
                 >
                   <img
                     src="https://em-content.zobj.net/source/microsoft-teams/337/party-popper_1f389.png"
                     alt="emoji"
                     height={"50px"}
                     width={"50px"}
                   />
           ...
           else if(message.message.code===11000){
            toast(
              () => (
                <div
                  style={{
  ...
  return (
    <section className=" h-[100vh] overflow-scroll">
      <div className="grid grid-cols-1 md:grid-cols-2 h-full">
        <div className="relative hidden  sm:flex flex-row items-center  justify-center  bg-gray-50 sm:px-6 lg:px-8 px-4 pb-10 pt-60 sm:pb-16 lg:pb-24">
          ...
          <div className="relative">
            <div className=" max-w-sm md:max-w-xl xl:w-full xl:mx-auto mx-auto xl:pr-24 xl:max-w-xl">
              <h3 className="text-4xl font-bold text-white">
                ...
                <Link to="/home" className="font-serif italic text-emerald-500">
                  foodiefrenzy
                </Link>{" "}
                fun - join us now!
              </h3>
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
            ...
            >
              <svg viewBox="0 0 403 88" className="css-1j8o68f m-auto mb-10 fill-emerald-500 h-12 md:h-14  ">
            ...
            <h2 className="text-3xl font-bold leading-tight dark:text-white sm:text-4xl">
              Sign up to <span className="text-emerald-500">Celebration</span>
            </h2>
            ...
            <form id="form-signup" className="mt-8">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="mt-2.5 relative text-gray-400 focus-within:text-zinc-900 dark:text-gray-400 dark:focus-within:text-gray-100">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                      <svg
                        className="w-5 h-5"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  <button
                    ...
                    type="submit"
                    className="inline-flex items-center justify-center w-full px-4 py-3 text-lg font-semibold text-white  transition-all duration-200 border border-transparent rounded-md bg-emerald-500 focus:outline-none hover:opacity-80 focus:opacity-80"
                  >
                    Sign up
                  </button>
                </div>
